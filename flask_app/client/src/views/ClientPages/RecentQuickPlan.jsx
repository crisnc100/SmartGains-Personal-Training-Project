...
const RecentQuickPlan = () => {
    const { clientId } = useParams();  // Changed from planId to clientId
        ...
        const fetchPlan = async () => {
            ...
            try {
                ...
                if (response.data.success) {
                    ...
                    setEditableData(response.data.demo_plan); // Initialize editableData with the same data
                } else {
    ...
    const saveChanges = () => {
        axios.post(`http://localhost:5000/api/update_recent_demo/${clientId}`, {
...
export default RecentQuickPlan;
