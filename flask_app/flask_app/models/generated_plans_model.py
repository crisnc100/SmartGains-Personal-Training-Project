...
class GeneratedPlan:
    ...
    def save(self):
        ...
        query = """
        INSERT INTO generated_plans (client_id, name, generated_plan_details, date, created_at, updated_at) 
        VALUES (%(client_id)s, %(name)s, %(generated_plan_details)s, NOW(), NOW(), NOW());
        """
    ...
    def update(cls, generated_plan_id,data):
        try:
            ...
            if result is not None and result > 0:  # Check if result is not None and greater than zero
